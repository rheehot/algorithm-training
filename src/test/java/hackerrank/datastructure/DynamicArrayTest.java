...
import hackerrank.datastructure.DynamicArray;
...
public class DynamicArrayTest {
    ...
    public void test() {
        //Given
        Integer seqListNumber = 100;
        List<List<Integer>> queries = Arrays.asList(Arrays.asList(1, 345255357, 205970905),
        ...
        List<Integer> expected = new ArrayList<>(Arrays.asList(855677723
                , 75865401
                , 763845832
                , 75865401
                , 709571211
        ...
        //When
        List<Integer> result = DynamicArray.dynamicArray(seqListNumber, queries);
    ...
    public void test2() {
        ...
        List<Integer> items2 = new ArrayList<>(2);
        //System.out.println(items2.get(0));

        List<Integer[]> item3 = new ArrayList();
        System.out.println(item3.get(0)[0]);

        List<Integer>[] myList = new ArrayList[3];
        System.out.println(myList[0].get(0));
